...
def main():
    ...
    print(
        f"   • Confusion matrix: runs/detect/clash_royale_FINAL_1280px/confusion_matrix.png"
    )
    ...
    try:
        total_epochs = (
            len(results.results_dict) if hasattr(results, "results_dict") else "N/A"
        )
