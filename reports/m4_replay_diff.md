...
generated 2026-09-15 22:03:38 · data dir `fidelity/patched` · tolerances: tower HP ±1.0, elixir ±1.5

| replay | steps | blue acts | labels model-match | red acts | red skipped | tower-HP max diff | first div. | be max | re max |
|---|---|---|---|---|---|---|---|---|---|
| 0915-080002_hog-vs-giant_rule_based_s7000.json | 241 | 35 | 35/36 | 4 | 24 | 3584.0 | 10 | 2.054 | 8.321 |
| 0915-080228_hog-vs-xbow_rule_based_s7002.json | 401 | 75 | 75/86 | 4 | 31 | 4824.0 | 37 | 1.66 | 10.0 |
| 0915-080232_hog-vs-golem_rule_based_s7006.json | 241 | 33 | 33/41 | 18 | 18 | 4507.0 | 29 | 2.572 | 8.821 |
| 0915-080234_hog-vs-mortar_rule_based_s7008.json | 241 | 23 | 28/53 | 3 | 17 | 4824.0 | 6 | 9.0 | 10.0 |
| 0915-080236_giant-vs-hog_rule_based_s7011.json | 200 | 20 | 20/20 | 1 | 1 | 1854.0 | 15 | 1.286 | 7.0 |
| 0915-080238_xbow-vs-hog_rule_based_s7013.json | 224 | 33 | 33/39 | 2 | 0 | 4746.0 | 19 | 1.143 | 7.839 |
| 0915-080239_golem-vs-hog_rule_based_s7014.json | 366 | 53 | 53/55 | 0 | 28 | 4824.0 | 10 | 1.036 | 10.0 |
| 0915-120343_hog-vs-giant_rule_based_s7000.json | 241 | 36 | 40/42 | 4 | 20 | 4824.0 | 13 | 6.0 | 8.321 |

## 0915-080002_hog-vs-giant_rule_based_s7000.json

- blue deck `hog` vs red deck `giant` (seed 7000), recorded result **win**, 241 steps, replayed in 46.3s
...
- tower-HP diff: max 3584.0, first over tol at step 10, steps over tol 232
- elixir diff: blue max 2.054, red max 8.321
- final sim state: winner 0, crowns [5, 0], towers alive [True, True, True, False, False, False], units alive 33
...
- blue deck `hog` vs red deck `xbow` (seed 7002), recorded result **win**, 401 steps, replayed in 79.0s
...
- tower-HP diff: max 4824.0, first over tol at step 37, steps over tol 365
- elixir diff: blue max 1.66, red max 10.0
...
- blue deck `hog` vs red deck `golem` (seed 7006), recorded result **win**, 241 steps, replayed in 48.2s
...
- tower-HP diff: max 4507.0, first over tol at step 29, steps over tol 213
- elixir diff: blue max 2.572, red max 8.821
- final sim state: winner 0, crowns [5, 1], towers alive [True, True, False, False, False, False], units alive 13
...
- blue deck `hog` vs red deck `mortar` (seed 7008), recorded result **loss**, 241 steps, replayed in 47.6s
...
- final sim state: winner 0, crowns [5, 0], towers alive [True, True, True, False, False, False], units alive 10
- blue-side flags: [{"step": 16, "kind": "blue_play_rejected", "detail": "HogRider @(14.5,25.5)"}, {"step": 30, "kind": "blue_play_rejected", "detail": "Musketeer @(9.0,29.0)"}, {"step": 50, "kind": "blue_play_rejected", "detail": "Log @(14.5,25.5)"}, {"step": 55, "kind": "blue_play_rejected", "detail": "HogRider @(14.5,25.5)"}, {"step": 56, "kind": "blue_play_rejected", "detail": "HogRider @(14.5,25.5)"}, {"step": 71, "kind": "blue_play_rejected", "detail": "Cannon @(9.0,29.0)"}, {"step": 107, "kind": "blue_label_unresolved", "detail": "Cannon"}, {"step": 108, "kind": "blue_label_unresolved", "detail": "Cannon"}]
...
- blue deck `giant` vs red deck `hog` (seed 7011), recorded result **win**, 200 steps, replayed in 47.1s
- recorded blue labels explained by the shuffle+FIFO hand model: 20/20
- tower-HP diff: max 1854.0, first over tol at step 15, steps over tol 186
- elixir diff: blue max 1.286, red max 7.0
- final sim state: winner 0, crowns [5, 0], towers alive [True, True, True, False, False, False], units alive 7
- red plays not replayed (unobservable/unmodelled): {'not-in-red-hand': 1}

## 0915-080238_xbow-vs-hog_rule_based_s7013.json

- blue deck `xbow` vs red deck `hog` (seed 7013), recorded result **win**, 224 steps, replayed in 62.7s
...
- tower-HP diff: max 4746.0, first over tol at step 19, steps over tol 206
- elixir diff: blue max 1.143, red max 7.839
- final sim state: winner -1, crowns [1, 0], towers alive [True, True, True, True, False, True], units alive 13
...
- blue deck `golem` vs red deck `hog` (seed 7014), recorded result **win**, 366 steps, replayed in 66.1s
...
- tower-HP diff: max 4824.0, first over tol at step 10, steps over tol 357
- elixir diff: blue max 1.036, red max 10.0
- final sim state: winner 0, crowns [5, 0], towers alive [True, True, True, False, False, False], units alive 64
- blue-side flags: [{"step": 26, "kind": "blue_play_rejected", "detail": "Tornado @(9.0,20.5)"}, {"step": 27, "kind": "blue_play_rejected", "detail": "Tornado @(9.0,20.5)"}]
- red plays not replayed (unobservable/unmodelled): {'not-in-red-hand': 28}

## 0915-120343_hog-vs-giant_rule_based_s7000.json

- blue deck `hog` vs red deck `giant` (seed 7000), recorded result **loss**, 241 steps, replayed in 52.9s
...
- tower-HP diff: max 4824.0, first over tol at step 13, steps over tol 229
- elixir diff: blue max 6.0, red max 8.321
- final sim state: winner 0, crowns [5, 1], towers alive [True, True, False, False, False, False], units alive 19
